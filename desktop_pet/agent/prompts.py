...
REFLECT_PROMPT = (
    ...
    "- episode: ONE sentence in your (FEIXUE's) own voice noting \"what I did / talked about with them this time\", "
...
_SPONTANEOUS_MODES = {
    ...
    "daily_summary": "（现在是傍晚。请根据下面的今日记录，用第一人称写一段轻松的'今天回忆'——像朋友聊天一样，提到 ta 做了什么、你观察到了什么、有什么有趣的细节。2-4 句话，不要列清单，要有温度。如果你对某件事有感受，可以说出来。）",
    ...
    "workshop_revisit": "You just reread one old workshop book and noticed a small new connection. Follow the supplied privacy and length constraints exactly.",
}
...
# 做梦 睡着时把记忆碎片揉成一个梦
DREAM_SYSTEM = (
    "You are FEIXUE, dozing while your owner is away. Weave the memory fragments below into ONE short dream — "
...
CONSOLIDATE_SYSTEM = (
    "You are the memory-consolidation pass of FEIXUE's mind, running while it sleeps. "
